                   ...
                   <div className="mx-auto text-left text-white relative z-10">
                       <div className="flex ">
                           <div className="w-1/2">
                               ...
                               <p className="text-xl mb-12">JIIT has been constantly ranked amongst the top engineering Institutes in Delhi NCR. Recently it has been ranked among top Engineering Institutes in India by Edu Rand 2014 Engineering College Rankings.</p>
               ...
               <p className=" mx-auto mt-6 text-center text-gray-500 dark:text-gray-300">
                   ...
                   <div className="grid grid-cols-1 gap-8 mx-auto mt-8 lg:grid-cols-2 xl:mt-10 max-w-7xl">
                       <div className="p-6 bg-gray-100 rounded-lg dark:bg-gray-800 md:p-8">
                           <p className="leading-loose text-gray-500 dark:text-gray-300 text-left">
                           ...
                           <div className="flex items-center mt-6">
                               <img className="object-cover rounded-full w-14 h-14" src="https://www.jiit.ac.in/sites/default/files/home-banner-1.jpg" alt="" />
                               <div className="mx-4">
                       ...
                       <div className="p-6 bg-gray-100 rounded-lg dark:bg-gray-800 md:p-8">
                           <p className="leading-loose text-gray-500 dark:text-gray-300 text-left">
                           &bull; To develop as a benchmark University in emerging technologies.<br></br>
                           &bull; To provide state-of-the-art teaching learning process and R&D environment.<br></br>
                           &bull; To harness human capital for sustainable competitive edge and social relevance.
                           </p>

                           <div className="flex items-center mt-6">
                               <img className="object-cover rounded-full w-14 h-14" src="https://www.jiit.ac.in/sites/default/files/1.jpg" alt="" />
                               <div className="mx-4">
          ...
          {[...Array(4)].map((_, index) => (
            <a href="#" key={index} className="shadow-2xl relative">
              <div className="h-full relative shadow-2xl shadow-green-900 overflow-hidden group">
                ...
                <img src="https://source.unsplash.com/random/400x400" className="w-full z-0 h-full object-fill example" alt="Service" />
              </div>
            </a>
          ))}
        </div>
