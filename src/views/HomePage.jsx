  ...
  <div className="text-center space-y-12">
    <div className="text-center text-3xl font-bold">
     ...
     <section className="bg-white dark:bg-gray-900">
               ...
               <p className="max-w-7xl mx-auto mt-6 text-gray-500 dark:text-gray-300 text-left" >
           ...
           <div className="relative flex">
               ...
               <div className="container flex flex-col justify-center min-h-0 px-4 py-5 lg:absolute lg:inset-x-0">
                   ...
                   <div className="mt-10 lg:mt-20 lg:flex lg:items-center">
                       <img className="object-cover object-center w-full lg:w-[32rem] rounded-lg h-96" src="https://img.freepik.com/free-vector/isolated-young-handsome-man-set-different-poses-white-background-illustration_632498-649.jpg?size=338&ext=jpg&ga=GA1.1.1395880969.1709596800&semt=ais" alt="" />
