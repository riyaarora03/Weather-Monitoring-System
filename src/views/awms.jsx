 ...
 <div className="h-full bg-opacity-50 bg-black flex items-center justify-center" style={{ background: 'rgba(0,0,0,0.5)' }}>
   <div className="mx-2 text-center flex flex-row gap-12">
     ...
     <div class="elfsight-app-9bdd6787-4b85-47a7-a56c-178c6ad0cd51" data-elfsight-app-lazy></div>
               ...
               <section className="bg-white dark:bg-gray-900">
                   <div className="container px-6 py-10 mx-auto">
                       ...
                       <div className="flex items-start mx-auto mt-16">
                           <div>
                               <p className="flex items-center text-center max-w-6xl text-gray-500 lg:mx-8">
               ...
               {/* <div style={{ width: '50%' }}>
               <div className="elfsight-app-9bdd6787-4b85-47a7-a56c-178c6ad0cd51" data-elfsight-app-lazy></div>
               </div> */}
                       </div>
                   </div>
               </section>
        ...
        <div className="items-center lg:flex">
            <div className="w-full lg:w-1/2 lg:mr-20">
                <div className="lg:max-w-lg">
                    ...
                    <p className="mt-3 text-gray-600 dark:text-gray-400 text-left">IoT revolutionizes weather monitoring by deploying sensors and weather stations to collect real-time data on temperature, humidity, wind speed, and more, transmitting it wirelessly to centralized platforms for analysis. Integrated with machine learning algorithms and other data sources like satellite imagery, IoT systems provide accurate weather forecasts and early warnings of severe events. Scalable and flexible, these systems support decision-making in agriculture, transportation, disaster management, and beyond, enabling proactive measures to mitigate risks and optimize operations.</p>
