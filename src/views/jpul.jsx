    ...
    <>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="container px-6 py-10 mx-auto">
          ...
          <p className="max-w-6xl mx-auto mt-6 text-center text-gray-500 dark:text-gray-300">
          ...
          <div className="grid grid-cols-1 gap-8 mx-auto mt-8 lg:grid-cols-2 xl:mt-10 max-w-7xl">
            <div className="p-6 bg-gray-100 rounded-lg dark:bg-gray-800 md:p-8">
              ...
              <div className="flex items-center mt-6">
                <img className="object-cover rounded-full w-14 h-14" src="https://media.licdn.com/dms/image/C4D0BAQFWUkB3NOP1Ow/company-logo_200_200/0/1631326344784?e=2147483647&v=beta&t=gdSySj3vIXG90YhNb_FsQcjl7VaYRh4IEiVjtbqQnC4" alt="" />
                <div className="mx-4">
            ...
            <div className="p-6 bg-gray-100 rounded-lg dark:bg-gray-800 md:p-8">
              <p className="leading-loose text-gray-500 dark:text-gray-300 text-left">
                <ul>
                  <li>&bull; To develop & operate technically sound projects in cost-effective manner.</li>
                  <li>&bull; Expand our installed capacity to develop a superior portfolio of assets.</li>
                  <li>&bull; To play a significant role in the growth of the Indian power sector.</li>
                  <li>&bull; Maintain a high level of social responsibility in the communities in which we operate.</li>
                </ul>
              </p>
